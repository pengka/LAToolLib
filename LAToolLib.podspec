#
# Be sure to run `pod lib lint LAToolLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'LAToolLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LAToolLib.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'LAToolLib/Classes/**/*'
  
  # s.resource_bundles = {
  #   'LAToolLib' => ['LAToolLib/Assets/*.png']
  # }
